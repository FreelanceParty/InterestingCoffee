...
<div class="js-slider hidden flex flex-col gap-2">
	<div class="min-w-52 max-w-[90%] max-h-80 relative m-auto">
		<div class="slide">
			<img class="w-full max-h-80 rounded-xl" src="https://img.freepik.com/premium-photo/cup-coffee-with-smoke-coming-out-it_836919-976.jpg">
		</div>
		<div class="slide">
			<img class="w-full max-h-80 rounded-xl" src="https://images.immediate.co.uk/production/volatile/sites/30/2020/08/health-benefits-of-coffee-main_image_700_350-cf61138.jpg?quality=90&fit=700,350">
		</div>
		<div class="slide">
			<img class="w-full max-h-80 rounded-xl" src="https://img.freepik.com/premium-photo/cup-coffee-with-coffee-beans-wooden-table-generative-ai_446633-29995.jpg">
		</div>
