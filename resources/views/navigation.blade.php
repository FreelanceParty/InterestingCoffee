...
<div id="js-navbar" class="flex flex-col overflow-y-auto w-1/12 h-full bg-yellow-300 p-4 gap-5 justify-between">
	<div class="flex flex-col gap-4 cursor-pointer">
		<div data-route="{{ route('content.home') }}" class="js-tab js-home-tab items-center flex flex-col gap-2">
			<i class="fa-sharp fa-solid fa-house fa-xl"></i>
			Home
		</div>
		<div data-route="{{ route('content.coffees') }}" class="js-tab js-coffees-tab cursor-pointer items-center flex flex-col gap-2">
			<i class="fa-sharp fa-solid fa-mug-saucer fa-xl"></i>
			Coffees
		</div>
		<div data-route="{{ route('content.spices') }}" class="js-tab js-spices-tab cursor-pointer items-center flex flex-col gap-2">
			<i class="fa-solid fa-candy-cane fa-xl"></i>
			Spices
		</div>
		<div data-route="{{ route('content.delicacies') }}" class="js-tab js-delicacies-tab cursor-pointer items-center flex flex-col gap-2">
